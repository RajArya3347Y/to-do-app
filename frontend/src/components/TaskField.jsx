...
function TaskField(props){
    ...
    return(
        <div className="w-[100%] flex my-2 justify-center items-center lg:px-10 md:px-7 sm:px-7 " id="task-field">
            <input className="bg-[#eaedee] lg:text-xl md:text-lg sm:text-sm lg:p-3 md:p-2 sm:p-2 rounded-l-4xl outline-0 w-[87%]" 
                type="text" 
